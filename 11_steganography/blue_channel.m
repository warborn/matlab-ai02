...
blue_cover = cover_image(:, :, 3);
blue_secret = secret_image(:, :, 3);

cover_bits = get_bits(blue_cover);
cover_comp_bits = compensate_bits(cover_bits);

secret_bits = get_bits(blue_secret);
...
imwrite(result_image, 'result_blue.png');

% Decryption Process
image = imread('result_blue.png');
