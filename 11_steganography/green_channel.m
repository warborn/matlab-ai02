...
green_cover = cover_image(:, :, 2);
green_secret = secret_image(:, :, 2);

cover_bits = get_bits(green_cover);
cover_comp_bits = compensate_bits(cover_bits);

secret_bits = get_bits(green_secret);
...
imwrite(result_image, 'result_green.png');

% Decryption Process
image = imread('result_green.png');
