...
substract_image = uint8(doubled_image - 30);
...
subplot(3, 4, 5), imshow(sum_image), title('Sum')
subplot(3, 4, 6), imshow(substract_image), title('Substraction')
subplot(3, 4, 8), imshow(multiplication_image), title('Multiplication')
subplot(3, 4, 7), imshow(division_image), title('Division')

subplot(3, 4, 9), bar(get_frequency(sum_image)), title('Sum Histogram')
subplot(3, 4, 10), bar(get_frequency(substract_image)), title('Substraction Histogram')
